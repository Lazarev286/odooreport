odoo.define('account_dynamic_reports.DynamicTbMain', function (require){
    ...
    var DynamicFrMain = AbstractAction.extend({
            ...
            self._rpc({
                ...
                if (initial_render) {
                    ...
                    self.$el.find('.extra-multiple').select2({
                        ...
                        .val('analytic_group').trigger('change')
                        ;
                }
        ...
        update_with_filter: function (event) {
            ...
            var output = { date_range: false, enable_filter: false, debit_credit: false, analytic_group: false };
            ...
            for (var i = 0; i < options_list.length; i++) {
                ...
                if (options_list[i].id === 'analytic_group') {
                    output.analytic_group = true;
                }
            }
            self._rpc({
                model: 'ins.financial.report',
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'data': { 'js_data': data },
                    'context': {
                        'active_model': 'ins.general.ledger',
                        'landscape': 1,
                        'from_js': true
                    },
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'data': { 'js_data': data },
                    'context': {
                        'active_model': 'ins.partner.ageing',
                        'landscape': 1,
                        'from_js': true
                    },
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'data': { 'js_data': data },
                    'context': {
                        'active_model': 'ins.partner.ledger',
                        'landscape': 1,
                        'from_js': true
                    },
